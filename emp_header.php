...
<header class="header">
    ...
    <div class="flex">
        ...
        <a href="emp_home.php" class="logo">M2L<span>.</span></a>

        <!-- NAVBAR -->
        <nav class="navbar">
            <a href="emp_home.php">Accueil</a>
            <a href="emp_about.php">À Propos</a>
            <a href="emp_taches.php">Tâches</a>
            <a href="emp_contact.php">Contacter</a>
        </nav>
        ...
        <div class="profile">
            <?php
                /* chaque page est en fonction de l'employé qui s'est connecté */
                $select_profile = $conn->prepare("SELECT * FROM `users` WHERE id = ?");
                $select_profile->execute([$employe_id]);
                $fetch_profile = $select_profile->fetch(PDO::FETCH_ASSOC);
            ?>
            <!-- éléments renseignés dans le logo user -->
            <!-- la photo qui représente la personne connectée est stocké dans un fichier -->
            <img src="uploaded_img/<?= $fetch_profile['image']; ?>" alt="">
            <p><?= $fetch_profile['name']; ?></p>
            <!-- bouton de maj -->
            <a href="emp_profile_update.php" class="btn">Mettre à jour le profil</a>
